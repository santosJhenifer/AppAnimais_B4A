...
try {
		Debug.PushSubsStack("AddItem (slidemenu) ","slidemenu",13,__ref.getField(false, "ba"),__ref,63);
...
try {
		Debug.PushSubsStack("Hide (slidemenu) ","slidemenu",13,__ref.getField(false, "ba"),__ref,91);
...
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (b4a.example.slidemenu.class, "_isvisible"),slidemenu.__c.getField(true,"False"))) { 
...
try {
		Debug.PushSubsStack("Initialize (slidemenu) ","slidemenu",13,__ref.getField(false, "ba"),__ref,28);
...
__ref.getField(false,"_mlistview").runMethod(false,"getTwoLinesAndBitmap").getField(false,"ImageView").runVoidMethod ("SetLayout",(Object)(slidemenu.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 13)))),(Object)(slidemenu.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 13)))),(Object)(slidemenu.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 24)))),(Object)(slidemenu.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 24)))));
 BA.debugLineNum = 42;BA.debugLine="mListView.Color = Colors.DarkGray";
Debug.ShouldStop(512);
__ref.getField(false,"_mlistview").runVoidMethod ("setColor",slidemenu.__c.getField(false,"Colors").getField(true,"DarkGray"));
...
try {
		Debug.PushSubsStack("isVisible (slidemenu) ","slidemenu",13,__ref.getField(false, "ba"),__ref,119);
...
try {
		Debug.PushSubsStack("mBackPanel_Touch (slidemenu) ","slidemenu",13,__ref.getField(false, "ba"),__ref,103);
...
Debug.ShouldStop(256);
__ref.runClassMethod (b4a.example.slidemenu.class, "_hide");
 };
...
try {
		Debug.PushSubsStack("mListView_ItemClick (slidemenu) ","slidemenu",13,__ref.getField(false, "ba"),__ref,109);
...
Debug.ShouldStop(4096);
 BA.debugLineNum = 110;BA.debugLine="Dim subname As String";
Debug.ShouldStop(8192);
_subname = RemoteObject.createImmutable("");Debug.locals.put("subname", _subname);
 BA.debugLineNum = 111;BA.debugLine="Hide";
Debug.ShouldStop(16384);
__ref.runClassMethod (b4a.example.slidemenu.class, "_hide");
 BA.debugLineNum = 112;BA.debugLine="subname = mEventName & \"_Click\"";
...
try {
		Debug.PushSubsStack("Out_AnimationEnd (slidemenu) ","slidemenu",13,__ref.getField(false, "ba"),__ref,99);
...
try {
		Debug.PushSubsStack("Show (slidemenu) ","slidemenu",13,__ref.getField(false, "ba"),__ref,78);
...
Debug.ShouldStop(16384);
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (b4a.example.slidemenu.class, "_isvisible"),slidemenu.__c.getField(true,"True"))) { 
if (true) return RemoteObject.createImmutable("");};
