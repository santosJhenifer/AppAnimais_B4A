...
public class tela_editarperfil implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("tela_editarperfil"), "b4a.example.tela_editarperfil");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, tela_editarperfil.class);
...
public static b4a.example.tela_feed _tela_feed = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",tela_editarperfil.mostCurrent._activity,"HttpUtils2Service",tela_editarperfil.mostCurrent._httputils2service,"ImageChooser",tela_editarperfil.mostCurrent._imagechooser,"Main",Debug.moduleToString(b4a.example.main.class),"spinnerCidade",tela_editarperfil.mostCurrent._spinnercidade,"Starter",Debug.moduleToString(b4a.example.starter.class),"Tela_CadDesap",Debug.moduleToString(b4a.example.tela_caddesap.class),"Tela_CadPET",Debug.moduleToString(b4a.example.tela_cadpet.class),"Tela_CadUsu",Debug.moduleToString(b4a.example.tela_cadusu.class),"Tela_EditarPET",Debug.moduleToString(b4a.example.tela_editarpet.class),"Tela_Feed",Debug.moduleToString(b4a.example.tela_feed.class),"Tela_ListarDesap",Debug.moduleToString(b4a.example.tela_listardesap.class),"Tela_ListarPET",Debug.moduleToString(b4a.example.tela_listarpet.class),"Tela_VizDesap",Debug.moduleToString(b4a.example.tela_vizdesap.class),"txtCelular",tela_editarperfil.mostCurrent._txtcelular,"txtEnd",tela_editarperfil.mostCurrent._txtend,"txtLoginUsu",tela_editarperfil.mostCurrent._txtloginusu,"txtNomeUsu",tela_editarperfil.mostCurrent._txtnomeusu,"txtSenhaUsu",tela_editarperfil.mostCurrent._txtsenhausu,"usu_foto",tela_editarperfil.mostCurrent._usu_foto};
}
}